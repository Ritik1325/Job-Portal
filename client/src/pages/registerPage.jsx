...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post('/register', { email, password, name, role }, { withCredentials: true });
            ...
            <div className='max-w-lg border-2 border-gray-300 rounded-lg m-auto  mt-12'>
                ...
                <form method='post' onSubmit={handleSubmit} className='flex flex-col box-border'>
                    ...
                    <div className='flex flex-col p-6 '>
                        ...
                        <input className='rounded-md focus:ring-2 border-2 border-blue-300 p-4 focus:border-blue-500 outline-none' type="text" name='name' value={name} onChange={(e) => setName(e.target.value)} placeholder='Name' required />
                    </div>
                    <div className='flex flex-col p-6 '>
                    ...
                    <div className='flex flex-col p-6 '>
                        ...
                        <input className='rounded-md focus:ring-2 border-2 border-blue-300 p-4 focus:border-blue-500 outline-none' type="text" name='Role' value={role} onChange={(e) => setRole(e.target.value)} placeholder='Jobseeker or Employer' required />
                    </div>
                    <div className='flex flex-col p-6 '>
                    ...
                    <div className='flex justify-center'>
                        <button className='p-4 rounded-2xl bg-blue-500 text-white font-bold w-32 text-center text-xl mb-4' type='submit'>Submit</button>
                    </div>
                </form>
