...
const UpdateJobs = () => {
    ...
    const { _id, title: initialTitle, company: initialCompany, location: initialLocation, description: initialDescription, mode: initialMode } = state || {};
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.put(`/jobs/${_id}`, { title, description, location, mode, company }, { withCredentials: true });
    ...
    return (
        <>
            <h1 className='text-4xl text-orange-400 font-extrabold text-center'>Update Job</h1>
